    ...
    return (
      <MutabilityContext.Provider value={this.state.mutability}>
        <div
          ...
          data-has-left={this.state.splitPositions[SplitPosition.left] > 0 || undefined}
          data-has-bottom={this.state.splitPositions[SplitPosition.bottom] > 0 || undefined}
          data-has-right={this.state.splitPositions[SplitPosition.right] > 0 || undefined}
        >
          {this.body()}
        </div>
